...
processed_2014.to_csv('2014_2015_training_data.csv', encoding='utf-8', index=False)
processed_2015.to_csv('2015_2016_training_data.csv', encoding='utf-8', index=False)
processed_2016.to_csv('2016_2017_training_data.csv', encoding='utf-8', index=False)
processed_2017.to_csv('2017_2018_training_data.csv', encoding='utf-8', index=False)
processed_2018.to_csv('2018_2019_training_data.csv', encoding='utf-8', index=False)